...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, User_1["default"].create(__assign({}, req.body))];
            case 1:
                user = _a.sent();
                token = user.createJWT();
                return [2, res.status(http_status_codes_1.StatusCodes.CREATED).json({
                        status: true,
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4, user.comparePassword(password)];
            case 2:
                ...
                token = user.createJWT();
                return [2, res.status(http_status_codes_1.StatusCodes.OK).json({
                        status: true,
