...
var isAdmin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decodedToken, adminId, admin, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, req.headers.authorization.split(" ")[1]];
            case 1:
                token = _a.sent();
                if (token === undefined) {
                ...
                return [4, jsonwebtoken_1["default"].verify(token, process.env.JWT_SECRET)];
            case 2:
                ...
                return [4, User_1["default"].findById(adminId)];
            case 3:
                admin = _a.sent();
                console.log(admin);
...
var isAuthorized = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decodedToken, userId, user, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (!req.headers.authorization) {
                    return [2, res.status(401).send({
                            statuscode: 401,
                            status: "error",
                            thetoken: "".concat(req.headers.authorization),
                            message: "No token provided"
                        })];
                }
                return [4, req.headers.authorization.split(" ")[1]];
